...
Gesture right = Gesture("s", 1, "RIGHT", 0);
Gesture left = Gesture("c", 1, "LEFT", 0);
Gesture right1 = Gesture("sj", 2, "RIGHT", 0);
Gesture left1 = Gesture("ct", 2, "LEFT", 0);
Gesture right2 = Gesture("sm", 2, "RIGHT", 0);
Gesture left2 = Gesture("cg", 2, "LEFT", 0);
Gesture right3 = Gesture("sd", 2, "RIGHT", 0);
Gesture left3 = Gesture("cb", 2, "LEFT", 0);
Gesture right4 = Gesture("js", 2, "RIGHT", 0);
Gesture left4 = Gesture("tc", 2, "LEFT", 0);
Gesture right5 = Gesture("ms", 2, "RIGHT", 0);
Gesture left5 = Gesture("gc", 2, "LEFT", 0);
Gesture right6 = Gesture("ds", 2, "RIGHT", 0);
Gesture left6 = Gesture("bc", 2, "LEFT", 0);
...
Gesture ges_lst[14] = {right6, left6, right5, left5, right4, left4, right3, left3, right2, left2, right1, left1, right, left};
